...
class Sport(Enum):
    ...
    def from_strava_type(cls, strava_type: str) -> 'Sport':
        ...
        type_mapping = {
            ...
            "Walk": cls.RUN,
            "Workout": cls.OTHER,
            "WeightTraining": cls.OTHER,
            "Crossfit": cls.OTHER,
            "Yoga": cls.OTHER
        }
        return type_mapping.get(strava_type, cls.OTHER)
...
class TCXProcessor:
    ...
    def convert_strava_to_tcx(self, activity_data: Dict[str, Any], streams: Dict[str, Any], sport: Sport) -> str:
        ...
        """
        # This is a simplified TCX generation - in a real implementation,
    ...
    async def analyze_activity_data(self, activity_data: Dict[str, Any], config: AnalysisConfig) -> str:
        ...
        """
        # Convert activity data to a format suitable for LLM analysis
        analysis_text = f"""
Activity Analysis Request:

Activity: {activity_data.get('name', 'Unknown')}
